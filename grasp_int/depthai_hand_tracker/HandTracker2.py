...
class HandTracker:
    ...
    def __init__(self, input_src=None,
        ...
        if self.input_src == None or self.input_src == "rgb" or self.input_src == "rgb_laconic":
        ...
        elif self.input_src.endswith('.jpg') or self.input_src.endswith('.png') :
            ...
            if self.input_src.isdigit():
                self.input_src = int(self.input_src)
    ...
    def lm_postprocess(self, hand, inference):
        ...
        if hand.lm_score > self.lm_score_thresh:  
            ...
            hand.landmarks = np.squeeze(cv2.transform(lm_xy, mat)).astype(np.int_)
