...
class KnownObjectPoseEstimator:
    def __init__(self, cam_mat, img_resolution, dataset = 'tless', render_txt =False, render_overlay = False, render_bboxes = True, 
...
def get_pose_estimator(type, cam_mat, img_resolution, use_tracking = True, fuse_detections = False):

    os.environ['CUDA_VISIBLE_DEVICES'] = '0'
    if type == 'cosypose':
        detector = KnownObjectPoseEstimator( cam_mat, img_resolution, use_tracking=use_tracking, fuse_detections=fuse_detections)
    return detector
